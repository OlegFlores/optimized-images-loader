...
exports.setCache = exports.getHash = exports.getCache = void 0;
...
const isValidCacheFolder = async cacheFolder => {
  ...
  try {
    ...
    try {
      ...
      return (e === null || e === void 0 ? void 0 : e.code) === 'EEXIST';
    }
  }
};
...
const getCache = async (hash, loaderOptions) => {
  ...
  try {
    const options = JSON.parse((await _fs.promises.readFile(_path.default.resolve(cacheFolder, `${hash}.json`))).toString());
