...
var _gifsicle = _interopRequireDefault(require("@oyflores/gifsicle"));
...
const optimizeGif = async (image, imageOptions, options) => {
  ...
  const encodedImage = await (0, _gifsicle.default)(image, encodeOptions);
...
var _default = exports.default = optimizeGif;