...
async function compress(image, options) {
  ...
  // @ts-ignore
  if (options !== null && options !== void 0 && options.mozjpeg && options.mozjpeg !== false) {
  ...
  // @ts-ignore
  if (options !== null && options !== void 0 && options.optipng && options.optipng !== false) {
  ...
  // @ts-ignore
  if (options !== null && options !== void 0 && options.pngquant && options.pngquant !== false) {
